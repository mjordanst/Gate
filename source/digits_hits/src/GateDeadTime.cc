...
GateDeadTime::GateDeadTime(GateSinglesDigitizer *digitizer)
  :GateVDigitizerModule("DeadTime","digitizerMgr/"+digitizer->GetSD()->GetName()+"/SinglesDigitizer/"+digitizer->m_digitizerName+"/deadtime",digitizer,digitizer->GetSD()),
   m_bufferSize(0),
   m_bufferMode(0),
   m_outputDigi(0),

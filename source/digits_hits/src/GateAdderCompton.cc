...
GateAdderCompton::GateAdderCompton(GateSinglesDigitizer *digitizer)
  :GateVDigitizerModule("AdderCompton","digitizerMgr/"+digitizer->GetSD()->GetName()+"/SinglesDigitizer/"+digitizer->m_digitizerName+"/adderCompton",digitizer,digitizer->GetSD()),
   m_outputDigi(0),

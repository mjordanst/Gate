...
#ifndef GateDigitizerOldMessenger_h
#define GateDigitizerOldMessenger_h 1
...
/*! \class GateDigitizerOldMessenger
    ...
    - GateDigitizerOldMessenger - by Daniel.Strul@iphe.unil.ch
*/
class GateDigitizerOldMessenger: public GateClockDependentMessenger
{
  public:
    GateDigitizerOldMessenger(GateDigitizerOld* itsDigitizer);  //!< constructor
    ~GateDigitizerOldMessenger();                            //!< destructor
  ...
  private:
   ...
   //! Inserts a new module into the pulse-processor list
    ...
    inline GateDigitizerOld* GetDigitizer()
      { return (GateDigitizerOld*) GetClockDependent(); }

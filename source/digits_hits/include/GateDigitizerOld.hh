...
#ifndef GateDigitizerOld_h
#define GateDigitizerOld_h 1
...
class GateDigitizerOldMessenger;
class GateHitConvertor;
class GateVDigiMakerModule;
class GateVSystem;
class GateHit;

class GateDigitizerOld : public GateClockDependent,public G4VDigitizerModule
{
public:
  static GateDigitizerOld* GetInstance();

protected:
  GateDigitizerOld();

public:
  virtual ~GateDigitizerOld();
  ...
  //! Return the hit convertor attached to the DigitizerOld
...
protected:
  G4String 					m_elementTypeName;	 //!< Type-name for all DigitizerOld modules

  GateVSystem*					m_system;		 //<! System to which the DigitizerOld is attached //mhadi_obso Obsolete
  ...
  GateDigitizerOldMessenger*    			m_messenger;
...
private:
  ...
  static GateDigitizerOld*      			theDigitizerOld;
  //public:
